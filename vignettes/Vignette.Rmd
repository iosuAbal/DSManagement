...
Supongamos que queremos discretizar en 3 intervalos de igual anchura los valores de un atributo: (utilizaremos los atributos ya creados)
```{r}
...
```
Podemos observar como ha creado un punto de corte diferent para cada atributo, de tal manera que hay la misma cantidad de elementos en cada intervalo de cada atributo.
...
```
Vemos que es prácticamente 0.5
